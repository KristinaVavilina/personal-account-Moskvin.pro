...
const reportGroups = [
  {
    ...
    items: [
      {
        id: 1,
        title: 'Выполнить монтаж ролика',
        text: 'Внезапно, элементы политического процесса представляют собой не что иное, как квинтэссенцию победы маркетинга над разумом и должны быть подвергнуты целой серии независимых исследований.',
        badge: 'Выполнено: 40%',
        time: '19:30 - 21:40',
      },
      {
